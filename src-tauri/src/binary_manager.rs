...
impl BinaryManager {
    ...
    pub async fn ensure_all_binaries(&self) -> Result<(), String> {
        ...
        // Check each binary (yt-dlp, ffmpeg, ffprobe, deno - Deno is the JS runtime yt-dlp
        // uses for YouTube extraction and cannot be assumed present on the end user's machine)
